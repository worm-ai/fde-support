...
- [ ] **Step 1: Confirm untracked dependency**
...
- [ ] **Step 2: Keep model gateway helper as production source**
...
- [ ] **Step 3: Ensure model gateway tests are tracked**
...
- [ ] **Step 5: Verify tracked-only build**
...
- [ ] **Step 1: Add validator test for escaping knowledge URI**
...
- [ ] **Step 3: Add delivery defense test**
...
- [ ] **Step 4: Implement delivery source/destination containment**
...
- [ ] **Step 1: Add release checker test**
...
- [ ] **Step 2: Define mandatory checks**
...
- [ ] **Step 3: Update `Checker.Run` filtering**
...
- [ ] **Step 1: Add evaluation runner test**
...
- [ ] **Step 3: Verify evaluation and release tests**
...
- [ ] **Step 1: Add compose/readme consistency test**
...
- [ ] **Step 2: Update README generation**
