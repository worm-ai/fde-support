...
- [x] **Step 1: Write failing tests for publish success and invalid component yaml**
...
- [x] **Step 3: Replace the YAML stub with real parsing**
...
- [x] **Step 4: Verify registry tests**
...
- [x] **Step 1: Write failing test for artifact references**
...
- [x] **Step 3: Copy manifest and knowledge data into outputDir**
...
- [x] **Step 4: Make compose runnable without missing build context**
...
- [x] **Step 5: Verify delivery tests and release smoke**
...
- [x] **Step 1: Add a gateway builder**
...
- [x] **Step 2: Replace app-level `model.NewMockGateway()` calls**
...
- [x] **Step 3: Add test for missing model config**
...
- [x] **Step 4: Verify app/model-related packages**
...
- [x] **Step 1: Add failing release test that missing report stays missing**
...
- [x] **Step 2: Introduce knowledge load options**
...
- [x] **Step 3: Use no-report loading in release**
...
- [x] **Step 1: Write logger redaction test**
...
- [x] **Step 2: Implement logger redaction**
...
- [x] **Step 3: Verify runtimecore tests**
...
- [x] **Step 1: Add model credential failure test**
...
- [x] **Step 2: Change `checkModelCredentials`**
...
- [x] **Step 3: Validate unknown release checks**
...
- [x] **Step 4: Decide and implement empty `releaseChecks` behavior**
...
- [x] **Step 5: Verify release and manifest tests**
...
- [x] **Step 1: Add `SolutionType` field**
...
- [x] **Step 2: Validate required `solutionType`**
...
- [x] **Step 4: Update examples and templates**
...
- [x] **Step 5: Verify manifest and command tests**
...
- [x] **Step 2: Implement `result_accuracy`**
...
- [x] **Step 3: Implement `escalation_precision`**
...
- [x] **Step 5: Verify evaluation tests**
